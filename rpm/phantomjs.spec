...
Source:		%{name}-%{version}-linux-x86_64.tar.bz2
...
mkdir -p %{buildroot}%{prefix}/share/%{name}/examples
...
%changelog
* Thu Aug 22 2013 Tatsuru WATANABE <w.tatsuru@gmail.com>
- merge origin
...
* Thu Jan 24 2013 Tatsuru WATANABE <w.tatsuru@gmail.com>
